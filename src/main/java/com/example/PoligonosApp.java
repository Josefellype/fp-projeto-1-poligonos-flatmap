...
public class PoligonosApp extends Application {
    ...
    public void start(final Stage mainStage) {
        ...
        pontosPoligonos.forEach(listaPontos -> {
                    ...
                    listaPontos.forEach(ponto -> poligono.getPoints().addAll(ponto.x(),ponto.y()));
    ...
    protected List<Double> perimetros(){
        ...
        return pontosPoligonos
                .stream()
                .flatMap(listaPontos -> {
                    Point ultimoPonto = listaPontos.get(listaPontos.size()-1);
                    Point primeiroPonto = listaPontos.get(0);
